...
@section('main')
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <h5 class="card-title mb-0">Data Galeri @yield('title')</h5>
                                <div>
    ...
    <input type="hidden" value="{{ $barang->id }}" id="kode_barang">
    @include('pages.admin.barang.modal-gambar')
@endsection
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            datatableCall('galeri-table', '{{ route('admin.barang-gambar.index') }}', [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex'
                },
                {
            ...
            $("#saveData").submit(function(e) {
                ...
                let url = "{{ route('admin.barang-gambar.store') }}";
                const data = new FormData(this);
                data.append("barang_id", {{ $barang->id }})
                if (kode !== "") {
                    data.append("_method", "PUT");
                    url = `/admin/barang-gambar/${kode}`;
                }
